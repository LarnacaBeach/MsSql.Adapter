...
public class AdapterCodeFixProvider : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds { get; }
       = ImmutableArray.Create(AdapterAnalyzer.EnumerationMustBePartial.Id);
    ...
    public override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            if (diagnostic.Id != AdapterAnalyzer.EnumerationMustBePartial.Id)
                continue;

            var title = AdapterAnalyzer.EnumerationMustBePartial.Title.ToString();
